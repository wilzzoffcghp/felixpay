...
export async function POST(req) {
  ...
  try {
    const url = `https://orderhostid.my.id/?action=createpayment&apikey=${process.env.ORDERKUOTA_API_KEY}&username=${process.env.ORDERKUOTA_USERNAME}&amount=${totalBayar}&token=${process.env.ORDERKUOTA_TOKEN}`;
